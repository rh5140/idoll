...
namespace Yarn.Unity
{
    ...
    /// by <see cref="LineViewCustom"/> to handle animating the presentation of lines.
    /// </summary>
    ...
    public class LineViewCustom : DialogueViewBase
    {
        ...
        /// </summary>
        /// <remarks>
        /// If the <see cref="LineViewCustom"/> receives a line that does not contain
        ...
        public override void UserRequestedViewAdvancement()
        {
            ...
            if (currentStopToken.CanInterrupt) 
            {
                ...
                return; // Don't load the next text box immediately!
            }
